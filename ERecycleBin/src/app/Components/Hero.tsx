...
import hero from "../../assets/AzadiKaAmritMahotsav.png";
      ...
      <div data-aos="fade-right" className="container mx-auto px-4">
        <div className="hero-content text-center">
          ...
          <h1 className="h1 hero-title text-center md:text-start font-bold mb-6">
            ...
            <br />{" "}
            <motion.span
              className="text-[var(--go-green-50)] pt-2"
          ...
          <p className="text-gray-700 mb-8 text-center md:text-start">
            ERecycleBin: Transforming E-Waste Management. Find E-waste
            facilities effortlessly with our platform. Your key to responsible
          ...
          <div className="flex flex-row md:flex-row items-center justify-center md:justify-start sm:space-y-0 md:space-x-4 mb-10">
            ...
            <a
              href="https://e-recycle-bin-admin-six.vercel.app/register/facility/"
              target="_blank"
