...
const Footer = () => {
  ...
  return (
    <footer className="footer shadow-2xl text-white bg-[var(--go-green)]">
      <div className="footer-top md:section">
        ...
        <div className="container">
          <div className="footer-brand">
            <Link href="/">
              <div className="flex justify-center items-center">
                <Image
                  src={logo}
                  className="h-48 w-48 object-contain bg-white rounded-full p-4 m-4"
                  alt=""
                />
              </div>
            </Link>
          ...
          <ul className="footer-list border-r-2">
            <li>
              <p className="footer-list-title">Our Services</p>
            </li>
            <li>
              <Link
                href="/recycle/smartphone"
                className="footer-link hover:text-white hover:underline"
              >
                Request Pickup
              </Link>
            </li>
          ...
          <ul className="footer-list">
            ...
            <li className="footer-item">
              ...
              <Link
                target="_blank"
                rel="noopener noreferrer"
                href="mailto:contact@erecyclebin.com"
                className="contact-link"
              >
                contact@erecyclebin.com{" "}
              </Link>
            </li>
            <li className="footer-item">
      ...
      <div className="footer-bottom">
        <div className="container">
          <p className="copyright">
            &copy; 2023 ERecycleBin | All Rights Reserved by{" "}
