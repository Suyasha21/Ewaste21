...
const FacilityMap: React.FC = () => {
  ...
  useEffect(() => {
    if (clientLocation) {
      ...
      console.log(sortedFacilities, facility);
      ...
      geocoder.on(
        ...
        (event: { result: { geometry: any; place_name: any } }) => {
          ...
          if (geometry && geometry.coordinates) {
            ...
            getDirections(center, [nearestFacility.lng, nearestFacility.lat]);
          }
        }
      );
      ...
      sortedFacilities.forEach((facility, index) => {
        const popup = new Popup().setHTML(
          `<h3 class="font-bold text-emerald-600 text-2xl">${
            facility.facilityName
              ...
              <p class="text-gray-600">Contact: ${facility.phone}</p>
        ...
        if (directionsBtn) {
          directionsBtn.addEventListener("click", () => {
            getDirections(clientLocation!, [facility.lng, facility.lat]);
          });
        }
        ...
        ${selectedFacility === index ? "bg-green-200" : ""}`}
          ...
          >
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-xl font-semibold">{info.facilityName}</h2>
            ...
            <div className="my-2">
              <p className="text-lg text-gray-600">Contact: {info.phone}</p>
