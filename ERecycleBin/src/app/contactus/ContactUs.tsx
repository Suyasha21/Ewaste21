...
const ContactUs = () => {
  ...
  return (
    <>
      <Head>
        <title>ERecycleBin- ContactUs</title>{" "}
      </Head>
      <div className="px-4 w-full py-16 lg:py-24 md:pb-32 md:container">
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 justify-center gap-8 mt-10">
            ...
            <div data-aos="fade-right" className="p-6 rounded-md shadow-md">
            ...
            <div className="p-6 rounded-md shadow-md" data-aos="fade-left">
              <ul className="footer footer-list">
                ...
                <li className="footer-item">
                  ...
                  <address className="contact-link address">Indore</address>
                </li>
                <li className="footer-item">
